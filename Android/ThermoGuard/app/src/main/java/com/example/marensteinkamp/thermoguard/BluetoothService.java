...
public class BluetoothService {
    ...
    private ArrayList<BluetoothService.ConnectedThread> mConnThreads;
    ...
    private void initializeArrayLists() {
        mDeviceAddresses = new ArrayList<String>(7);
        mDeviceNames = new ArrayList<String>(7);
        mConnThreads = new ArrayList<BluetoothService.ConnectedThread>(7);
        mSockets = new ArrayList<BluetoothSocket>(7);
        mUuids = new ArrayList<UUID>(7);
    ...
    public synchronized void checkForDisconnectedBLE(){
            ...
            public void run() {
                for(int i=0;i<7;i++){
                    if(mConnThreads.get(i)==null){
                        ...
                        bundle.putInt(MainActivity.DEVICE_NUMBER,
                                i);
                        msg.setData(bundle);
    ...
    public synchronized void connect(BluetoothDevice device,int selectedPosition) {
        ...
        if (getPositionIndexOfDevice(device) == -1) {
            ...
            try {
                ...
                BluetoothService.ConnectThread mConnectThread = new BluetoothService.ConnectThread(device,
                        selectedPosition);
...
//        if (mAcceptThread != null) {mAcceptThread.cancel(); mAcceptThread = null;}
        ...
        mConnectedThread = new ConnectedThread(socket,selectedPosition);
...
//        mHandler.sendMessage(msg);
    ...
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, int selectedPosition) {
            mmDevice = device;
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket,int selectedPosition) {
...
//                    }
                    ...
                    Message msg = mHandler.obtainMessage(MainActivity.MESSAGE_DEVICE_NAME);
                    Bundle bundle = new Bundle();
                    bundle.putString(MainActivity.DEVICE_NAME, mmSocket.getRemoteDevice().getAddress());
                    msg.setData(bundle);
                    mHandler.sendMessage(msg);
                    ...
                    mConnThreads.set(selectedPosition,null);
                    mDeviceAddresses.set(selectedPosition,null);
                    mDeviceNames.set(selectedPosition,null);
                    connectionLost();
